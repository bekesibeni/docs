...
The response is a full [ITrade](/reference/types#itrade) object. Each withdrawal item carries its own `status` field that mirrors the trade-level status as it progresses.
