...
| 1504 | `VERIFICATION_BANNED_IDENTITY` | The matched identity is banned |
| 1505 | `VERIFICATION_ACCOUNT_CAP_REACHED` | Identity has reached its max-linked-accounts limit |
| 1506 | `VERIFICATION_ALREADY_LINKED` | Client is already linked to an identity |
| 1507 | `VERIFICATION_LINK_FAILED` | No verified identity matches the email |
| 1510 | `VERIFICATION_EMAIL_REQUIRED` | No email on the client — pass one in `/start` first |
